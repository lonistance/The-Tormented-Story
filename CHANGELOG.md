...
**#23 (2026-08-17) — Volume 2 Chapter 14《分别》drafted — VOLUME 2 COMPLETE (14/14)**
- **Content**: appended to `第二卷 持剑的孩子.md`, ending the volume — the climax of the volume (per direction, the knight takes the initiative and rides after him). Dawn mist on the south road: Kael walking, touching the amulet under his clothes (his mother's cord, "戴着它，走得再远，也不会迷路" — failing him this morning because he no longer knows which way is right); hoofbeats out of the mist — the old horse, and the knight who has never ridden after anyone. A long ride in silence, their year's native tongue; at the crossroads he dismounts and gives him the plain sword — no inscription, no ornament, old cloth-wrapped hilt, tied by the rider's own hands: "这把够你用了。" — "师父，我会让它成为传奇。" (the knight hears his own old sentence in it; "真正重要的，不是剑。""我知道。是我。") The name, finally: 凯尔 asks it at the end — "艾德里安·瓦尔。" — the first and last time the name enters the text: the knight neither confirms nor denies the bard's tale ("那个人死了很久了"), gives the name away as he gave the sword: "离开战场以后，我就把名字丢了。今天捡回来——交给你。""因为从今天起，你替我记住。" The embrace — his first since infancy — and the three sentences that miss: "如果有一天，你累了，回来。" / "我不会失败。" / "我不是这个意思。" — 凯尔 does not understand, turns, walks the wide road, does not look back; the knight stands at the crossroads, the horse snorting into his palm, the cloak lifted by the wind — no tears. Close: the amulet and the sword are the same kind of thing — sentences someone could not say, sewn into an object to carry down the road; and the two sentences he cannot hear today he will need decades to understand — on the day he does, there will be no road back. (Pays off: ch6 "名字落在路上了", ch7's bard's tale, ch10's six swallowed words, ch13's "明天清晨，南边的大路上"; plants: the plain sword = vol 5's firewood (failed) and vol 6's village guard — the un-legendary sword, like the boy he began as.)
